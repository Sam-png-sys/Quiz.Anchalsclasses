    ...
    <AdminShell>
      <main className="max-w-6xl mx-auto w-full px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white tracking-tight">Leaderboard & Results</h1>
            <p className="text-sm text-white/35 mt-1">
              Track student performance and quiz attempt records
            </p>
          </div>
        </div>
