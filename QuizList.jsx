      ...
      <main className="max-w-6xl mx-auto w-full px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={() => {
                if (subjectId && courseTitle) {
                  navigate(`/subjects?courseId=${searchParams.get("courseId") || ""}&course=${encodeURIComponent(courseTitle)}`);
                } else {
                  navigate("/dashboard");
                }
              }}
            ...
            <div>
              ...
              <p className="text-sm text-white/35 mt-1">
                {subjectName ? `${subjectName} · ` : ""}{processed.length} quiz{processed.length !== 1 ? "zes" : ""} found
              </p>
            </div>
          </div>
